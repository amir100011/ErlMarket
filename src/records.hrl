...
-define(PURCHASE_DEPARTMENT_NODE,node()).% 'amir@172.16.147.165' ).
-define(CASHIER_SERVER_NODE,node()).% 'amir@172.16.147.165').
-define(MASTER_SERVER_NODE,node()).%  'dor@132.72.54.107').
-define(INTERFACE_NODE, node()).% 'dor@132.72.54.107').
-define(NodeList, [?INTERFACE_NODE]).%, ?CASHIER_SERVER_NODE, ?MASTER_SERVER_NODE, ?INTERFACE_NODE]).
